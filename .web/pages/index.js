...
export function Button_3f41850db7cd7113f5edec33790e1600 () {
  ...
  return (
    <RadixThemesButton css={{"width": "6.5em", "height": "2.em", "borderRadius": "0.7em", "fontSize": "80%", "paddingInlineStart": "0.7em", "paddingInlineEnd": "0.7em", "paddingTop": "0.7em", "paddingBottom": "0.7em", "backgroundColor": "#373de1", "border": "2px solid #6474f0", "color": "#eef4ff", "backgroundImage": "linear-gradient(#6474f0, #373de1)", "&:hover": {"backgroundImage": "linear-gradient(#373de1, #393bc9)"}}} onClick={on_click_829758d0490a7fa8206219b3e88b9eb1}>
...
export function Textfield__input_e05af4ddf176bc08ab52576f528b9f18 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
  ...
  return (
    <RadixThemesTextField.Input css={{"width": "100%", "colorScheme": "whiteAlpha"}} onBlur={on_blur_ce8b2331a880fc9468bf3bb159d8c0fa} placeholder={`Pega el enlace aquí`} variant={`classic`}/>
  )
}
...
export default function Component() {
  ...
  <RadixThemesFlex align={`start`} css={{"position": "sticky", "minHeight": "100vh", "maxHeight": "max-content", "width": "100%", "left": "0px", "zIndex": "5", "paddingInlineStart": "0", "paddingInlineEnd": "0", "paddingTop": "1em", "paddingBottom": "1em", "backgroundColor": "#373de1", "transition": "width 2s", "display": "inline", "alignItems": "center"}} direction={`column`} gap={`2`}>
  ...
  <Textfield__input_e05af4ddf176bc08ab52576f528b9f18/>
  <Button_3f41850db7cd7113f5edec33790e1600/>
</RadixThemesFlex>
</RadixThemesFlex>
