...
export function Img_3a698a09495ddd008ced3cf6116e6882 () {
  const state__youtube_info = useContext(StateContexts.state__youtube_info)


  return (
    <img css={{"width": `${state__youtube_info.data_info.img_width}px`, "alignSelf": "center", "padding": "1.2em"}} src={state__youtube_info.data_info.img_src}/>
  )
}
...
export function Button_bb7586e331b89fc04dd2c9ea4e071aaa () {
  const state__youtube_info = useContext(StateContexts.state__youtube_info)
  const [addEvents, connectErrors] = useContext(EventLoopContext);

  const on_click_f91a7bd7835e024a3397c4c10c7affa1 = useCallback((_e) => addEvents([Event("_console", {message:state__youtube_info.getDataYoutubeInfo})], (_e), {}), [addEvents, Event, state__youtube_info])

  return (
    <RadixThemesButton onClick={on_click_f91a7bd7835e024a3397c4c10c7affa1}>
  {`log`}
</RadixThemesButton>
  )
}
...
export function Heading_c7df16ebbc75c3e801b0ac8e24bbceac () {
  const state__youtube_info = useContext(StateContexts.state__youtube_info)


  return (
    <RadixThemesHeading css={{"fontSize": "150%", "marginBottom": "1em", "color": "#1b1c4b", "textShadow": "4px 4px 4px #8298f7", "textAlign": "center"}}>
  {state__youtube_info.data_info.title}
</RadixThemesHeading>
  )
}
...
export default function Component() {
  ...
  <Button_bb7586e331b89fc04dd2c9ea4e071aaa/>
  <RadixThemesGrid columns={`2`} css={{"width": "100%", "height": "100%", "align": "center", "templateColums": "40% 60%", "templateRows": "500px"}} rows={`1`}>
  <Img_3a698a09495ddd008ced3cf6116e6882/>
  <RadixThemesGrid columns={`1`} css={{"padding": "1.2em", "marginInlineStart": "1.5em", "marginInlineEnd": "1.5em"}} rows={`3`}>
  <Heading_c7df16ebbc75c3e801b0ac8e24bbceac/>
</RadixThemesGrid>
</RadixThemesGrid>
